...
var chartDashboardKelaminDivision = new ApexCharts(document.querySelector("#chart-dashbord-jenis-kelamin-division"), options17);
var charUmurDivision = new ApexCharts(document.querySelector("#chart-dashbord-umur-division"), options17);
var charKartapDivision = new ApexCharts(document.querySelector("#chart-dashbord-kartap-division"), options17);
var charTotalEmployeeDivision = new ApexCharts(document.querySelector("#chart-dashbord-total-employee"), options17);
// chart17.render();
chartDashboardKelaminDivision.render();
charUmurDivision.render();
charKartapDivision.render();
charTotalEmployeeDivision.render();
// chart-4 dashbord
// var options21 = {
//   series: [{
//       name: 'series1',
