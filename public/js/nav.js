...
var html = '';
html += html = "";
html += html = '<div class="customizer-links">';
html += html = '   <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">';
html += html = '      <a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#">';
html += html = '         <div class="settings"><i class="icofont icofont-train-line"></i></div>';
html += html = '         <span>Riwayat Kedinasan</span> ';
html += html = '      </a>';
html += html = '      <a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#c-pills-home">';
html += html = '         <div class="settings"><i class="icofont icofont-tasks-alt"></i></div>';
html += html = '         <span>Riwayat Penugasan Khusus</span> ';
html += html = '      </a>';
html += html = '      <a class="nav-link" id="c-pills-home-tab1" data-bs-toggle="pill" href="#c-pills-profile">';
html += html = '         <div class="settings color-settings"><i class="icofont icofont-learn"></i></div>';
html += html = '         <span>Riwayat Prestasi</span> ';
html += html = '      </a>';
html += html = '      <a class="nav-link" id="c-pills-home-tab1" data-bs-toggle="pill" href="#c-pills-profile">';
html += html = '         <div class="settings color-settings"><i class="icofont icofont-group-students"></i></div>';
html += html = '         <span>Riwayat Pendidikan</span> ';
html += html = '      </a>';
html += html = '      <a class="nav-link" id="c-pills-home-tab1" data-bs-toggle="pill" href="#c-pills-profile">';
html += html = '         <div class="settings color-settings"><i class="icofont icofont-education"></i></div>';
html += html = '         <span>Riwayat Tranning</span> ';
html += html = '      </a>';
html += html = '   </div>';
html += html = ' </div>';
html += html = ' ';
