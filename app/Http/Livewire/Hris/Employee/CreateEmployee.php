...
class CreateEmployee extends Component
{
    ...
    public function createForm()
    {
        ...
        $validatedData = Validator::make($this->state, [
            ...
            'email' => 'required',
            'avatar' => 'nullable',
            'nik_telkom' => 'nullable|numeric|unique:users,nik_telkom',
            'nik_company' => 'required|numeric|unique:users,nik_company',
            'date_in' => 'required',
        ...
        $validatedData['password'] = Hash::make('admedika@321');
    ...
    public function render()
    {
        ...
        return view('livewire.hris.employee.create-employee', compact('bandPositions', 'jobGrades', 'jobFamilies', 'jobFunctions', 'jobTitles', 'cityRecuites', 'statusEmployee', 'subStatus', 'companyHosts', 'companyHomes', 'direktorats', 'direktorats', 'workLocations', 'edus'));
    }
}
