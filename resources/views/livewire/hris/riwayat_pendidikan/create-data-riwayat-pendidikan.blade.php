<div>
    @section('title')@lang('crud.educational_backgrounds.name')
    {{ $title }}
    @endsection
    @component('components.breadcrumb')
        @slot('breadcrumb_title')
            <h3>@lang('crud.educational_backgrounds.new_title')</h3>
        @endslot
        <li class="breadcrumb-item">@lang('crud.educational_backgrounds.name')</li>
        <li class="breadcrumb-item active">@lang('crud.educational_backgrounds.create_title')</li>
    @endcomponent
    <div class="container">
        <div class="container">
            <div class="card">
