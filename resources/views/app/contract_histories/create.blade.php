<x-admin-layout>
    ...
    @component('components.breadcrumb')
        ...
        <li class="breadcrumb-item active">@lang('crud.contract_histories.create_title')</li>
    @endcomponent
<div class="container">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">
                ...
                ></a>
                @lang('crud.contract_histories.create_title')
            </h4>

            <x-form
                method="POST"
                action="{{ route('contract-histories.store') }}"
                class="mt-4"
            >
