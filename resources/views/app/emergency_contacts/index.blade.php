    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.emergency_contacts.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.emergency_contacts.inputs.name')
                            </th>
                            <th class="text-left">
                                @lang('crud.emergency_contacts.inputs.contact')
                            </th>
                            <th class="text-left">
                                @lang('crud.emergency_contacts.inputs.relation')
                            </th>
                            <th class="text-left">
                                @lang('crud.emergency_contacts.inputs.profile_id')
                            </th>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('emergency-contacts.edit', $emergencyContact) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $emergencyContact)
                                    <a
                                        href="{{ route('emergency-contacts.show', $emergencyContact) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $emergencyContact)
                                    <form
                                        action="{{ route('emergency-contacts.destroy', $emergencyContact) }}"
                                        method="POST"
