    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.direktorats.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('direktorats.edit', $direktorat) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $direktorat)
                                    <a
                                        href="{{ route('direktorats.show', $direktorat) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $direktorat)
                                    <form
                                        action="{{ route('direktorats.destroy', $direktorat) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $direktorats->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
